...
//    }()
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        self.dataManager = DataManagerCoreData(modelName: "NotebooksModel", completionHandler: { (persistentContainer) in
        ...
        self.appCoordinator = AppCoordinator(window: sceneWindow, dataManager: self.dataManager)
